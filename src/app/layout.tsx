...
export const metadata = {
  ...
  description:
    "하우로그(HowLog)는 다양한 분야의 How-to 가이드와 튜토리얼을 제공하는 지식 아카이브입니다. 기술, 생활, 창작 등 여러 주제의 실용적인 방법을 기록하고 공유합니다.",
  keywords: [
    "하우로그",
    "HowLog",
    "How-to",
  ...
  openGraph: {
    ...
    description:
      "다양한 분야의 How-to 가이드와 튜토리얼을 제공하는 지식 아카이브",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
    ...
    <html lang="ko" suppressHydrationWarning>
      <head>
        <meta
          ...
          content="OkmGvofVfy3Ovq0Gc37sZSscUqUoKXzQL6NPggxUV_Y"
        />
        <meta
          name="naver-site-verification"
          content="179a8bfe3e50234694e5d71f27a02db527f879d7"
        />
