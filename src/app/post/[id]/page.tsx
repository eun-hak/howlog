...
export default async function PostDetailPage({ params }: PageProps) {
  ...
  const jsonLd = {
    ...
    image:
      post.coverImage ||
      `${
        process.env.NEXT_PUBLIC_SITE_URL || "https://howlog.jisiknarae.com"
      }/og-image.png`,
    ...
    author: {
      "@type": "Organization",
      name: "하우로그",
      url: process.env.NEXT_PUBLIC_SITE_URL || "https://howlog.jisiknarae.com",
    },
    publisher: {
      "@type": "Organization",
      name: "하우로그",
        ...
        <div className="container mx-auto px-4 max-w-5xl py-6 flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 max-w-[680px] mx-auto w-full">
            ...
            <section className="article-content text-gray-800">
              <div
                className="[&_h2]:text-lg md:[&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-gray-900 [&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:pb-2 [&_h2]:border-b [&_h2]:border-gray-200
            ...
            <section className="mt-6 p-3 md:p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h3 className="font-semibold text-blue-900 mb-1.5 text-xs md:text-sm">
                궁금한 점이 있으신가요?
              </h3>
              ...
              <Link href="/contact">
                <Button
                  variant="default"
                  size="sm"
                  className="bg-blue-600 hover:bg-blue-700 text-xs h-7 md:h-8 px-3"
                >
                  문의하기
                </Button>
              </Link>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="flex gap-2">
                  <Button
                    size="icon"
                    variant="outline"
                    className="rounded-full h-9 w-9 text-blue-600 border-blue-100 bg-blue-50 hover:bg-blue-100"
                  >
                  ...
                  <Button
                    size="icon"
                    variant="outline"
                    className="rounded-full h-9 w-9 text-blue-800 border-blue-100 bg-blue-50 hover:bg-blue-100"
                  >
                  ...
                  <Button
                    size="icon"
                    variant="outline"
                    className="rounded-full h-9 w-9 text-blue-700 border-blue-100 bg-blue-50 hover:bg-blue-100"
                  >
          ...
          <aside className="hidden lg:block w-72 shrink-0 space-y-6 sticky top-20 self-start">
            ...
            <section>
              <h3 className="font-semibold text-gray-900 mb-3 text-xs uppercase tracking-wider">
                {category?.name} 인기글
              </h3>
                ...
                {relatedPosts.slice(0, 3).map((p) => (
                  <Link key={p.id} href={`/post/${p.id}`}>
                    <div className="group cursor-pointer">
                      <h4 className="text-xs font-medium text-gray-900 group-hover:text-orange-600 leading-snug mb-1">
                        {p.title}
                      </h4>
