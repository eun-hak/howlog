...
export default async function PostDetailPage({ params }: PageProps) {
    ...
    const jsonLd = {
        ...
        headline: post.title,
        description: post.summary,
        image: post.coverImage || `${process.env.NEXT_PUBLIC_SITE_URL || 'https://howlog.jisiknarae.com'}/og-image.png`,
        ...
        publisher: {
            ...
            logo: {
                '@type': 'ImageObject',
                url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://howlog.jisiknarae.com'}/og-image.png`,
            },
        },
        mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': `${process.env.NEXT_PUBLIC_SITE_URL || 'https://howlog.jisiknarae.com'}/post/${post.id}`,
        },
