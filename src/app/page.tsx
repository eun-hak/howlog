    ...
    <div className="flex flex-col gap-12 pb-20">
      ...
      <section className="py-16 md:py-24 text-center space-y-6 max-w-2xl mx-auto px-4">
        ...
        <div className="flex justify-center gap-4 pt-4">
          <Link href="/category/content">
            <Button
              size="lg"
              className="rounded-full px-8 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700"
            >
              콘텐츠 둘러보기
            </Button>
          </Link>
      ...
      <section className="container mx-auto px-4 max-w-5xl">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button variant="link" className="text-orange-600 hidden sm:flex">
