...
export const metadata = {
  title: '개인정보 처리 방침 | 하우로그',
  description: '하우로그의 개인정보 처리 방침을 확인하세요.',
};
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 
            개인정보를 처리·보유합니다.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 다음의 개인정보 항목을 처리하고 있습니다:
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다:
          </p>
          <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 서비스 제공을 위해 쿠키를 사용합니다. 쿠키는 웹사이트가 귀하의 브라우저에 전송하는 작은 텍스트 파일로, 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 광고 서비스를 제공하기 위해 제3자 광고 제공업체(Google AdSense 등)를 이용합니다.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            정보주체는 HowLog에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>개인정보 처리정지 요구</li>
            <li>개인정보 열람 요구</li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            HowLog는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            HowLog는 만 14세 미만 아동의 개인정보를 보호하기 위하여 만 14세 미만 아동의 회원가입을 받지 않습니다. 
